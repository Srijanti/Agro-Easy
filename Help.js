...
const Help = () => {
  const booking_help = [
    {
      heading: "Q: How do I book an equipment on Agro-Easy",
      content:
  ...
  const renting_help = [
    ...
    },
    {
      ...
      content:
        "A: You can post all types of farming eqipment on AgroEasy. For Example, Trucks, Tractors, etc.",
    },
  ];

  //const handleClick = () => {
    // Redirect to the Instagram page
   // window.location.href = '../src/pages/ContactUs/ContactUs';
 // };
  return (
    <div className="">
